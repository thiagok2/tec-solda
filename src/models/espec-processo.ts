...
export class EspecProcesso {
	...
	buildSoldagemDeTopoV() {
		...
		let classificacaoEletrodoAWSArray = ['E6010', 'E7018', 'E6010', 'E7018', 'E6010', 'E7018', 'E6010', 'E7018', 'E6010', 'E7018'];
		let diametroEletrodoArray = ['3,2', '4', '3,2', '4', '3,2', '4', '3,2', '4', '3,2', '4'];
		let correnteEletricaIntervaloArray = ['110', '170', '110', '170', '110', '170', '110', '170', '110', '170'];
		let velocidadeSoldagemIntervaloArray = ['11', '9', '11', '9', '11', '10', '11', '11', '11', '10'];

		let indice = undefined;
		this.numPasses = this.paramCalc.numPasse;

		if (this.paramCalc.espessura != undefined && this.numPasses == 1) {
			indice = 0;
		} else if (this.paramCalc.espessura == 8 && this.numPasses == 2) {
			indice = 1;
			...
			indice = 5;
		} else if (this.paramCalc.espessura == 19.1 && this.numPasses >= 2 && this.numPasses <= 9) {
			indice = 7;
		} else if (this.paramCalc.espessura == 25.4 && this.numPasses >= 2 && this.numPasses <= 13) {
			indice = 9;
		} else {
			return;
		}
